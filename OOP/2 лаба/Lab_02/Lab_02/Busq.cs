...
namespace Lab_02
{
    public partial class Bus
    {
        ...
        и out-параметры.*/
        public void IncreaseMileage(ref int transportMileage)//при передаче парамаетров исп ref
        {
            transportMileage++;
        }

        public void ChangeDriver(out string oldName, string newName)//Чтобы сделать параметр выходным, перед ним ставится модификатор out
        {
            oldName = newName;
        }
