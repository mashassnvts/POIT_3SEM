...
namespace lab_03
{
    ...
    public class List
    {
        ...
        public List()//Конструктор выполняется при создании нового объекта класса List.
        {
            Head = Tail = new Node();
            _count = 0;
        }
        ...
        //Необходимые методы
        public void AddElem(string data)//Метод выполняет операции для добавления нового элемента в структуру данных.
        {
