...
//Здесь создаются псевдонимы для удобства использования структур данных.
...
int main()
{
	...
	GAM::Graph graphSecond;// Создание объекта графа типа GraphAdjacencyMatrix (матрица смежности)
	//Для матрицы
